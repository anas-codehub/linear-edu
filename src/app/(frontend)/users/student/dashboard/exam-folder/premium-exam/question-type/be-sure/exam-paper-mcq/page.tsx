...
const Page = () => {
  ...
  const calculateScore = () => {
    return questions.filter((q) => selectedOptions[q.id] === q.correctAnswer)
      .length;
  };
  ...
  const calculateResults = () => {
    ...
    const wrong = questions.filter(
      (q) => selectedOptions[q.id] && selectedOptions[q.id] !== q.correctAnswer
    ).length;
                        ...
                        >
                          ...
                          {!isCorrect && !isSkipped && (
                            <p className="mt-3 ml-8 text-sm text-red-600 dark:text-red-400">
                              আপনার উত্তর: {userAnswer}, সঠিক উত্তর:{" "}
                          ...
                          {isSkipped && (
                            <p className="mt-3 ml-8 text-sm text-amber-600 dark:text-amber-400">
                              আপনি এই প্রশ্নের উত্তর দেননি, সঠিক উত্তর:{" "}
                              {question.correctAnswer}
                            </p>
                          )}
                        </div>
          ...
          <CardBody className="p-6 md:p-8">
            ...
            <div className="flex justify-center">
              <Button
                ...
                size="lg"
              >
                জমা দিন ({Object.keys(selectedOptions).length}/
                {questions.length})
              </Button>
            </div>
            ...
            <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
              <p className="text-sm text-amber-700 dark:text-amber-300 text-center">
                💡 নির্দেশনা: কমপক্ষে ১টি প্রশ্নের উত্তর দিলে জমা দিতে পারবেন।
                সময় শেষ হয়ে গলে স্বয়ংক্রিয়ভাবে জমা হয়ে যাবে।
              </p>
            </div>
          </CardBody>
        </Card>
